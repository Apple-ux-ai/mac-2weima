...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--base-url", default=os.getenv("LLM_BASE_URL", os.getenv("DASHSCOPE_BASE_URL", "https://dashscope.aliyuncs.com/compatible-mode/v1")), help="OpenAI-compatible base URL (百炼: compatible-mode/v1; Coding: coding.dashscope.aliyuncs.com/v1)")
